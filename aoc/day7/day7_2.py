...
entries = ["light chartreuse bags contain 1 mirrored yellow bag, 2 vibrant violet bags.",
           ...
           "dark lavender bags contain 2 faded purple bags.", "dark white bags contain 5 muted green bags.",
           ...
           "dim bronze bags contain 5 drab blue bags.", "wavy brown bags contain 3 dotted crimson bags.",
           ...
           "faded tan bags contain 5 dotted gold bags.", "drab white bags contain 3 posh violet bags.",
           "muted teal bags contain 4 dotted purple bags, 5 dark maroon bags, 3 dotted magenta bags, 1 pale beige bag.",
           "dark magenta bags contain 3 posh red bags.", "shiny cyan bags contain 3 dull red bags, 1 light coral bag.",
           ...
           "clear magenta bags contain 4 pale olive bags.", "wavy blue bags contain 4 light gray bags.",
           "pale maroon bags contain 1 dim aqua bag, 3 dotted fuchsia bags, 1 clear brown bag, 1 drab turquoise bag.",
           "muted purple bags contain no other bags.", "vibrant plum bags contain 5 wavy beige bags.",
           ...
           "pale tan bags contain 4 bright cyan bags.", "vibrant magenta bags contain 3 light magenta bags.",
           ...
           "striped salmon bags contain 3 light yellow bags.", "bright orange bags contain 2 shiny orange bags.",
           "mirrored white bags contain 1 clear fuchsia bag.", "striped coral bags contain no other bags.",
           ...
           "mirrored indigo bags contain 2 dull beige bags.", "drab lavender bags contain 3 striped lime bags.",
           "bright gold bags contain 5 posh silver bags.", "dull fuchsia bags contain 2 striped tomato bags.",
           ...
           "mirrored cyan bags contain 3 clear white bags.", "shiny silver bags contain 4 vibrant coral bags.",
           ...
           "posh plum bags contain 3 vibrant maroon bags.", "clear turquoise bags contain 1 dim purple bag.",
           ...
           "pale gold bags contain 1 striped coral bag.", "bright plum bags contain 5 faded aqua bags.",
           ...
           "dim teal bags contain 2 muted coral bags.", "vibrant aqua bags contain no other bags.",
           ...
           "drab salmon bags contain 1 dull indigo bag.", "faded salmon bags contain 2 bright blue bags.",
           ...
           "posh green bags contain 5 pale blue bags.", "faded chartreuse bags contain 2 shiny red bags.",
           ...
           "mirrored gold bags contain 3 vibrant coral bags.", "plaid turquoise bags contain 5 striped coral bags.",
           ...
           "drab chartreuse bags contain 3 shiny crimson bags.", "shiny magenta bags contain 2 striped plum bags.",
           ...
           "light indigo bags contain 4 mirrored purple bags.", "faded brown bags contain 2 dim gold bags.",
           ...
           "plaid brown bags contain 3 drab indigo bags.", "faded cyan bags contain 3 light lavender bags.",
           ...
           "shiny aqua bags contain 1 muted coral bag.", "striped aqua bags contain 2 posh bronze bags.",
           ...
           "posh brown bags contain 2 mirrored turquoise bags.", "vibrant tan bags contain 3 drab gray bags.",
           ...
           "striped purple bags contain 2 drab white bags.", "pale coral bags contain 3 plaid teal bags.",
           ...
           "wavy coral bags contain 5 shiny gold bags.", "dull brown bags contain 4 mirrored tan bags.",
           "pale gray bags contain 5 dim maroon bags.", "dim tan bags contain 5 clear blue bags, 1 wavy bronze bag.",
           "plaid bronze bags contain 4 bright coral bags, 1 dotted crimson bag, 1 mirrored black bag."]
'''
entries = ["light red bags contain 1 bright white bag, 2 muted yellow bags.",
...
'''
entries = ["shiny gold bags contain 2 dark red bags.", "dark red bags contain 2 dark orange bags.",
...
def count_all_containees(rule_map, container):
    for rule_key, rule_values in rule_map.items():
        if rule_key == container:
            result = 0

            for entry_value in rule_values:
                value_split = entry_value.split(" ", 1)
                container_qty = int(value_split[0])
                all_containees_qty = count_all_containees(rule_map, value_split[1])
                result += container_qty + container_qty * all_containees_qty
...
for rule in entries:
    ...
    if "no other" not in rule_split[1]:
        container = rule_split[0].split("bag")[0].strip()
        containees = rule_split[1].split(",")

        if container not in rule_map:
            rule_map[container] = []

        for item in containees:
            rule_map[container].append(item.split("bag")[0].strip())

print(count_all_containees(rule_map, "shiny gold"))
