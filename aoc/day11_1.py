...
def adjacent_seat_calc(grid, row_index, col_index):
    if row_index < 0:
        return 0
    elif col_index < 0:
        return 0
...
def adjacent_seat_sum_calc(grid, row_index, col_index):
    return adjacent_seat_calc(grid, row_index - 1, col_index - 1) + adjacent_seat_calc(grid, row_index - 1,
                                                                                       col_index) + adjacent_seat_calc(
        grid, row_index - 1, col_index + 1) + adjacent_seat_calc(grid, row_index, col_index - 1) + adjacent_seat_calc(
        grid, row_index,
        col_index + 1) + adjacent_seat_calc(
        grid, row_index + 1, col_index - 1) + adjacent_seat_calc(grid, row_index + 1, col_index) + adjacent_seat_calc(
        grid, row_index + 1,
        col_index + 1)
